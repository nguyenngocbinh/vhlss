...
# Import all file
file_vhlss_2014 <- Sys.glob("vhlss2014/*.dta")
dt <- rio::import_list(file_vhlss_2014)
...
thanh_vien <- dt_join %>%
  ...
  mutate(
    ...
    marital_status = case_when(
      m1ac8 == 1 ~ 'Chưa có vợ/chồng',
      m1ac8 == 2 ~ 'Đã có vợ/chồng',
      m1ac8 == 3 ~ 'Góa',
      m1ac8 == 4 |
        m1ac8 == 5 ~ 'Ly hôn/Ly thân',
      TRUE ~ 'missing'
    ),
    quanhe = case_when(
      m1ac3 == 1 ~ 'Chủ hộ',
    ...
    dung_thpt = case_when((edu_now >= 10 &
                          ...
                          TRUE ~ 0),
    nuocsach = case_when(m7c18 == 5 |
                           m7c18 == 7 | m7c18 == 10 ~ 0, TRUE ~ 100),
    loainha = case_when(
      m7c4d == 1 ~ 'Nhà biệt thự',
